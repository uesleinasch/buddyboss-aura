...
<?php
$aura_single_content = 'aura_entry_content';
if ( is_single() ) {
		$aura_single_content = 'aura_single_post';
} 
global $post;
$aura_content = get_post_type() ? 'aura-content-' . get_post_type() : '';
?>

<article auraClass=<?php echo $aura_content ?> id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content-wrap primary-entry-content <?php echo $aura_single_content ?>">
		<?php
