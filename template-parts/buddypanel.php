<?php
$buddyPanel = 'aura-buddypanel';
?>
<aside class="<?php echo $buddyPanel ?> buddypanel <?php echo esc_attr( buddyboss_theme_get_option( 'buddypanel_toggle' ) ? 'buddypanel--toggle-on' : 'buddypanel--toggle-off' ); ?>">
	<?php
